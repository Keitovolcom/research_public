...
def main():
    ...
    experiment_name = f'{args.model}_width{args.model_width * 64}_{args.dataset}_lr{args.lr}_batch_size{args.batch_size}_epoch{args.epoch}_LabelNoiseRate{args.label_noise_rate}_Optim{args.optimizer}'
