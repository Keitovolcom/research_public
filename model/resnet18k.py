...
class PreActResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, init_channels=2):
        ...
        self.layer1 = self._make_layer(block, 64*c, num_blocks[0], stride=1)
        self.layer2 = self._make_layer(block, 128*c, num_blocks[1], stride=2)
        self.layer3 = self._make_layer(block, 256*c, num_blocks[2], stride=2)
        self.layer4 = self._make_layer(block, 512*c, num_blocks[3], stride=2)
        self.linear = nn.Linear(64*8*c*block.expansion, num_classes)
